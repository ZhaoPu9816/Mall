...
//	$('#mediumContainer img').eq(0).attr('src', 'img/404zfx' + ($(this).index() + 1) + '.jpg');
//	$('#img_u img').eq(0).attr('src', 'img/404zfx' + ($(this).index() + 1) + '.jpg');
	$('#mediumContainer img').eq(0).attr('src', 'img/404zfx' + '.jpg');
	$('#img_u img').eq(0).attr('src', 'img/404zfx' + '.jpg');
})